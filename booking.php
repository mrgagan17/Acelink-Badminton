...
<body>
    ...
    <div class="container-fluid p-5">
        <div class="mb-5 text-center">
            <h5 class="text-primary text-uppercase">Book Court </h5>
        ...
        <div class="row g-0">
            <div class="col-lg-6">
				...
				<?php echo"You are booking for Court No: ".$_SESSION['CNO'];echo"<br>";?>
				<?php echo"Your ID is : ".$_SESSION['EMAIL'];?>
                    <form id="request" class="main_form" action="booking_save.php" method="post">
                        <div class="row g-3">
							...
							<div class="col-12">
							Time:
                                <input type="time" class="form-control bg-light border-0 px-4" name="btime" placeholder="from" style="height: 55px;"required>
                            </div>
